package edu.ucne.textinputinjetpackcompose.presentation.LoginScreen
...
@Composable
fun ToggleVisibilityPasswordScreen() {
    ...
    Column(
        ...
        OutlinedSecureTextField(
            ...
            trailingIcon = {
                Icon(
                    if (passwordVisibile) Icons.Filled.Visibility else Icons.Filled.VisibilityOff,
                    contentDescription = "Toggle password visibility",
                    modifier = Modifier
                        .semantics { contentType = ContentType.Password }
                        .clickable{ passwordVisibile = !passwordVisibile}
                )
            },
            textObfuscationMode = if (passwordVisibile) Visible else RevealLastTyped
        )
